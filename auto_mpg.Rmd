...
ggroc(list(roc.glm, roc.gam, roc.lda, roc.qda), legacy.axes = TRUE) + 
...
When shreshold is 0.4, we should choose Logistic Regression model or GAM
...
When shreshold is 0.5, we should choose Logistic Regression model or GAM or LDA 
...
When shreshold is 0.6, we should choose MARS
